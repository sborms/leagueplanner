...
[![PyPI](https://img.shields.io/pypi/v/leagueplanner)](https://pypi.org/project/leagueplanner)
...
The league planner is also made available through a hosted [Streamlit application](https://leagueplanner.streamlit.app).
