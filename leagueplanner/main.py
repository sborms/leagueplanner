...
from leagueplanner.utils import gather_stats, setup_logger
...
# NOTE: Documentation of the PlannerParams is copy-pasted from the dataclass
...
def main(
    ...
    penalties = input.penalties or PlannerParams().penalties
    ...
    for sheet_name in input.sheet_names:
        ...
        d_val = planner.validate_calendar(df, fl_net_rest_days=net)
