...
class TransportationProblemSolver:
    ...
    def __init__(
        ...
        :param m: See PlannerParams for parameter details.
        :param p: See PlannerParams for parameter details.
        :param r_max: See PlannerParams for parameter details.
        :param penalties: See PlannerParams for parameter details.
        """
